...
agent any
  stages {
    stage('Run Neoload') {
      steps {
        echo "Hello World"
        neoloadRun executable: '/Users/sa20099277/.jenkins/workspace/Common_Performance_Testing/Library/Python/3.8/bin/neoload', localProjectFile: '/Users/sa20099277/neoload_projects/sample/sample.nlp', testDescription: 'To check its working', scenario: 'scenario 1', trendGraphs: ['AvgResponseTime', 'ErrorRate']
